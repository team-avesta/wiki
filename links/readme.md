...
* [A com­plete real-world pro­duc­tion exam­ple of a sophis­ti­cat­ed Web­pack 4 config](https://nystudio107.com/blog/an-annotated-webpack-4-config-for-frontend-web-development)
...
* [Two hour GraphQL course for React developers by Hasura](https://learn.hasura.io/graphql/react/)
...
* [SPA SEO](https://snipcart.com/spa-seo) -- A Single-Page App Guide to Google’s 1st Page. Single-page application (SPA) SEO is hard—not impossible. Read this resource-packed guide to optimize your React, Vue or Angular app for Google.
